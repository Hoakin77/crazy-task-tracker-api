package org.example.crazy.task.tracker.api.controller;

import org.example.crazy.task.tracker.api.controller.helper.ControllerHelper;
import org.example.crazy.task.tracker.api.dto.AckDto;
import org.example.crazy.task.tracker.api.dto.TaskStateDto;
import org.example.crazy.task.tracker.api.exceptions.BadRequestException;
import org.example.crazy.task.tracker.api.exceptions.NotFoundException;
import org.example.crazy.task.tracker.api.factories.TaskStateDtoFactory;
import org.example.crazy.task.tracker.store.entities.ProjectEntity;
import org.example.crazy.task.tracker.store.entities.TaskStateEntity;
import org.example.crazy.task.tracker.store.repositories.TaskStateRepository;
